...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await event.edit("Removed image's Background in {} seconds, powered by @surajit1".format(ms))
    else:
        await event.edit("ReMove.BG API returned Errors. Please report to @surajit1\n`{}".format(output_file_name.content.decode("UTF-8")))
